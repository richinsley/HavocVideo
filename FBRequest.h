...
// jl we need these for asset and file video streaming
...
// The size of read packets to limit when going over 3g
@property(nonatomic, readwrite) int throttleSize;
...
/**
 * Called during uploading to indicate progress.
 */
