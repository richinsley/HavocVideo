...
- (void) moveAlert: (UIAlertView *) alertView
{
	...
	if (![self isLandscape])
		alertView.center = CGPointMake(160.0f, 90.0f);
	else 
...
{
	return [ModalAlert textQueryWith:question prompt:prompt button1:@"No" button2:@"Yes"];
}

+ (NSString *) askShareOrCancel: (NSString *) question withTextPrompt: (NSString *) prompt
{
	return [ModalAlert textQueryWith:question prompt:prompt button1:@"Cancel" button2:@"Share"];
}

+ (NSString *) askLoginOrCancel: (NSString *) question withTextPrompt: (NSString *) prompt
{
	return [ModalAlert textQueryWith:question prompt:prompt button1:@"Cancel" button2:@"Login"];
}

+ (NSString *) askGoOrCancel: (NSString *) question withTextPrompt: (NSString *) prompt
{
	return [ModalAlert textQueryWith:question prompt:prompt button1:@"Cancel" button2:@"Go"];
}
@end
